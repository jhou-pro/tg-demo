...
import jhou.webapp.WebUiResources;
...
/**
 * Configuration point for Jhou Airport Asset Management Web Application.
 * 
 * @author Generated
 * 
 */
        ...
        try {
            ...
            getDefaultHost().attach(
                    new WebUiResources(
                            ...
                            injector,
                            "Jhou Airport Asset Management",
                            "An application server for Jhou Airport Asset Management",
                            "Jhou Asset Management Pty. Ltd.",
                            "Authors",
                            webApp
                            ));
